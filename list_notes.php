...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['group_id']) && isset($_POST['exam_id'])) {
        ...
        if ($group_id && $exam_id) {
            ...
            header("Location: afficher_notes_details.php?group_id=$group_id&exam_id=" . urlencode($exam_id));
        ...
        <div class="page-header text-center text-md-start">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p>Choisissez un groupe et un examen pour voir les notes des étudiants</p>
                </div>
            </div>
        </div>
